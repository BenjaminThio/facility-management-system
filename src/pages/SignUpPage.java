...
public class SignUpPage extends Page {
    ...
    public void render(StringBuilder frame)
    {
        ...
        fields[2].setPlaceholderColor(selection == 2 || fields[2].error() ? Ansi.FG_BLACK : Ansi.FG_DARK_GRAY);
        fields[3].setPlaceholderColor(selection == 3 || fields[3].error() ? Ansi.FG_BLACK : Ansi.FG_DARK_GRAY);
        fields[4].setPlaceholderColor(selection == 4 || fields[4].error() ? Ansi.FG_BLACK : Ansi.FG_DARK_GRAY);
        ...
        form.append("\n           ");
        form.append(new Ansi(" Sign Up ", selection == 7 ? Ansi.BG_LIGHT_GREEN : Ansi.BG_WHITE, Ansi.FG_BLACK));
    ...
    private void signUp()
    {
        ...
        User newUser = new User(this.fields[0].getValue(), this.fields[1].getValue().toLowerCase(), this.fields[3].getValue(), this.fields[2].getValue(), User.Role.cast(role), this.faculty);

        Global.setUser(newUser);
        Database.User.add(Global.getUser());
        Database.User.save();
        Global.setSession(newUser);
...
public class SignUpPage extends Page {
    ...
    private void signUp()
    {
        ...
        User newUser = new User(this.fields[0].getValue(), this.fields[1].getValue().toLowerCase(), this.fields[3].getValue(), this.fields[2].getValue(), User.Role.cast(role));
