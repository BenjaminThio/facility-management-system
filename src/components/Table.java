...
public class Table {
    public static AnsiBuilder toAnsiBuilder(ArrayList<ArrayList<AnsiBuilder>> table)
    {
        AnsiBuilder tableBuilder = new AnsiBuilder();
    ...
    public static void render(StringBuilder tableBuilder, ArrayList<ArrayList<AnsiBuilder>> table)
    {
        int colCount = table.stream().mapToInt(ArrayList::size).max().orElse(0);
